...
<head>
    ...
    <style type="text/tailwindcss">
		...
		.link {
			@apply font-medium text-gray-700 underline decoration-cyan-500;
		}
		...
		.success-flash {
			@apply relative mb-10 rounded border border-green-400 bg-green-100 px-4 py-3 text-sm text-green-700;
		}
	</style>
...
<body class="container mx-auto mt-10 mb-10 max-w-lg">
    <h1 class="mb-2 text-2xl">@yield('title')</h1>
    @if (session()->has('success'))
        <div x-data="{ flash: true }" x-show="flash">
            <div class="success-flash" role="alert">
